...
import { ArrowRight, Calendar, TrendingUp, Award, LogIn, AlertCircle, AlertTriangle, CheckCircle, Lock } from 'lucide-react'
      ...
      <div className="wrap py-12 max-w-4xl">
        ...
        {tests.length > 0 && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
            {[
              { label: 'Tests passés',    value: tests.length,                              icon: '📋' },
              { label: 'Score moyen',     value: avgScore + '%',                            icon: '📊' },
              { label: 'Cas critiques',   value: critCount,                                 icon: '🚨' },
              { label: 'Meilleur score',  value: bestTest ? bestTest.percent + '%' : '-',   icon: '🏆' },
